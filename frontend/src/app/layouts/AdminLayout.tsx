  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="flex h-screen bg-admin-page-bg">
        ...
        <aside
          className={cn(
            'fixed inset-y-0 left-0 z-30 flex w-64 shrink-0 flex-col bg-admin-sidebar-bg text-white transition-transform duration-300 lg:static lg:translate-x-0 lg:z-auto',
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="ghost" size="icon" className="relative h-8 w-8 text-slate-500">
                    ...
                    <span className="absolute top-1 right-1 h-2 w-2 rounded-full bg-admin-accent" />
                  </Button>
                </TooltipTrigger>
